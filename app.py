...
st.set_page_config(page_title="PolicyNavigator", page_icon="📋", layout="centered")
st.title("📋 PolicyNavigator")
...
if query := st.chat_input("E.g. 'Explain our KYC policy and test me'"):
